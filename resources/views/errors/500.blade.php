...
<body class="">
  <header class="not-homepage">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item nav-item__menu">
              <a href="/shipyard" class="hover-underline-animation ">SHIPYARD</a>
            </li>
            <li class="nav-item nav-item__menu">
              <a href="/marine-vendor" class="hover-underline-animation ">MARINE VENDOR</a>
            </li>
            <li class="nav-item nav-item__menu">
              <a href="/tender" class="hover-underline-animation ">TENDER</a>
            </li>
            <li class="nav-item nav-item__menu">
              <a href="/for-sale" class="hover-underline-animation ">FOR SALE</a>
            </li>
            <li class="nav-item nav-item__menu">
              <a href="/news" class="hover-underline-animation ">NEWS</a>
            </li>
            <li class="nav-item nav-item__menu" style="margin-left: 0;">
              <a href="/shipyard-job-vacancy" class="hover-underline-animation ">JOB
                VACANCY</a>
            </li>
          </ul>
        </div>
    ...
    <div class="container position-relative header__menu">
      <div class="row">
        <div class="col"><a href="/shipyard"
            class="btn btn-outline-secondary w-100">SHIPYARD</a></div>
        <div class="col"><a href="/marine-vendor" class="btn btn-outline-secondary w-100">MARINE
            VENDOR</a></div>
        <div class="col"><a href="/tender" class="btn btn-outline-secondary w-100">TENDER</a>
        </div>
        <div class="col"><a href="/for-sale" class="btn btn-outline-secondary w-100">FOR
            SALE</a></div>
        <div class="col"><a href="/news" class="btn btn-outline-secondary w-100">NEWS</a></div>
        <div class="col"><a href="/shipyard-job-vacancy"
