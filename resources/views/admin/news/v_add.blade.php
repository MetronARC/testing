  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="main__header d-flex justify-content-between">
        <h1 class="h3">Add New <strong>News</strong></h1>
                ...
                <div class="col-lg-12">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="title" id="news__title"
                      placeholder="Input News Title" value="">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-12">
                  <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" name="description" id="news__description" rows="4"
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" name="content" id="news__content" placeholder="Input Content"></textarea>
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-12">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="start_date" id="news__start_date"
                      placeholder="Input Start Date" value="{{ date('m/d/Y') }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
