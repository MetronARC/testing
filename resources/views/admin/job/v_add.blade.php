    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="main__header d-flex justify-content-between">
                <h1 class="h3">Add New <strong>Job</strong></h1>
                        ...
                        <form action="{{ url()->current() }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="form__company" placeholder="Input Company" value="{{ Request::post('company') }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control {{ !empty($errors['responsible']) ? 'is-invalid' : '' }}" name="responsible"
                                    id="form__responsible" placeholder="Input Responsible" rows="4">{{ Request::post('responsible') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control {{ !empty($errors['requirement']) ? 'is-invalid' : '' }}" name="requirement"
                                    id="form__requirement" placeholder="Input Requirement" rows="4">{{ Request::post('requirement') }}</textarea>
                                <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group date">
                                            <input
                                                ...
                                                value="{{ Request::post('posted_start_at') }}" />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group date">
                                            <input
                                                ...
                                                value="{{ Request::post('posted_end_at') }}" />
