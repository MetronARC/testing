  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="main__header d-flex justify-content-between">
        <h1 class="h3"><strong>Shipyard</strong> Detail</h1>
            ...
            <form action="{{ url()->current() }}" method="post" enctype="multipart/form-data"
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select select2-select" name="type" id="shipyard__type">
                      ...
                      @foreach (config('custom')['type'] as $_key => $_val)
                        <option value="{{ $_key }}" {{ $shipyard['type'] == $_key ? 'selected' : '' }}>
                          {{ strtoupper($_val) }}
                        </option>
                      @endforeach
                    </select>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="shipyard__name"
                      placeholder="Input Shipyard Name" value="{{ $shipyard['name'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-6 mb-3">
                  ...
                  <div class="row">
                    @if (!empty($shipyard['logo']))
                      <div class="col-3">
                        <img src="{{ cdnUrl($shipyard['logo']) }}" class="w-100" alt="logo" />
                      </div>
                    @endif
                    <div class="{{ !empty($shipyard['logo']) ? 'col-9' : 'col-12' }}">
                      <input type="file" class="form-control {{ !empty($errors['logo']) ? 'is-invalid' : '' }}"
                        name="logo" id="shipyard__logo" placeholder="">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="other_name" id="shipyard__other_name"
                      placeholder="Input Other Name" value="{{ $shipyard['other_name'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="listing_number" id="shipyard__listing_number"
                      placeholder="Input Listing Number" value="{{ $shipyard['listing_number'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select select2-input" name="location" id="shipyard__location">
                      ...
                      @foreach ($shipyardLocations as $_val)
                        <option value="{{ $_val }}" {{ $shipyard['location'] == $_val ? 'selected' : '' }}>
                          {{ strtoupper($_val) }}
                        </option>
                      @endforeach
                    </select>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select select2-multiples-notag" name="category[]" id="shipyard__category"
                      ...
                      @foreach (config('custom')['category'] as $_val)
                        <option value="{{ strtolower($_val) }}"
                          {{ in_array(strtolower($_val), explode(', ', $shipyard['category'])) ? 'selected' : '' }}>
                          {{ strtolower($_val) }}
                        </option>
                      @endforeach
                    </select>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" name="office_address" id="shipyard__office_address"
                      placeholder="Input Office Address" rows="4">{{ $shipyard['office_address'] }}</textarea>
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" name="office_phone" id="shipyard__office_phone"
                      placeholder="Input Office Phone" value="{{ $shipyard['office_phone'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                ...
                <select class="form-select select2-multiples-notag" name="branch[]" id="shipyard__branch"
                  ...
                  @foreach ($shipyards as $_val)
                    <option value="{{ $_val['id'] }}"
                      {{ in_array($_val['id'], explode(', ', $shipyard['branch'])) ? 'selected' : '' }}>
              ...
              <div class="mb-3">
                ...
                <input type="tel" class="form-control" name="website_url" id="shipyard__website"
                  placeholder="Input Website URL" value="{{ $shipyard['website_url'] }}">
                <div class="invalid-feedback"></div>
              </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="latitude" id="shipyard__latitude"
                      placeholder="Input Latitude" value="{{ $shipyard['latitude'] ?? '' }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="longitude" id="shipyard__longitude"
                      placeholder="Input longitude" value="{{ $shipyard['longitude'] ?? '' }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="rfq_email" id="rfq_email"
                      placeholder="Input RFQ Email" value="{{ $shipyard['rfq_email'] ?? '' }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" name="rfq_phone" id="rfq_phone"
                      placeholder="Input RFQ Phone" value="{{ $shipyard['rfq_phone'] ?? '' }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="service_shiprepair" value="1"
                      id="service_shiprepair" {{ !empty($shipyard['service']['ship_repair']) ? 'checked' : '' }}>
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="service_building" value="1"
                      id="service_building" {{ !empty($shipyard['service']['ship_building']) ? 'checked' : '' }}>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="construction_steel" value="1"
                      id="construction_steel" {{ !empty($shipyard['construction']['steel']) ? 'checked' : '' }}>
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="construction_aluminium" value="1"
                      id="construction_aluminium" {{ !empty($shipyard['construction']['aluminium']) ? 'checked' : '' }}>
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="construction_other" value="1"
                      id="construction_other" {{ !empty($shipyard['construction']['other']) ? 'checked' : '' }}>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="established_year" id="shipyard__establish_year"
                      placeholder="Input Establish Year" value="{{ $shipyard['established_year'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="group" id="shipyard__group"
                      placeholder="Input Group" value="{{ $shipyard['group'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="total_area" id="shipyard__total_area"
                      placeholder="Input Total Area" value="{{ $shipyard['total_area'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="water_depth" id="shipyard__waterdepth"
                      placeholder="Input Water Depth" value="{{ $shipyard['water_depth'] }}">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-3">
                <textarea class="form-control" name="slipway" id="shipyard__slipway" placeholder="Input Slipway" rows="4">{{ $shipyard['slipway'] }}</textarea>
              </div>
              ...
              <div class="mb-3">
                <textarea class="form-control" name="jetty" id="shipyard__jetty" placeholder="Input Jetty" rows="4">{{ $shipyard['jetty'] }}</textarea>
              </div>
              ...
              <div class="mb-3">
                <textarea class="form-control" name="crane" id="shipyard__crane" placeholder="Input Cranes" rows="4">{{ $shipyard['crane'] }}</textarea>
              </div>
              ...
              <div class="mb-3">
                <textarea class="form-control" name="certificate" id="shipyard__certificate" placeholder="Input Certificates"
                  rows="4">{{ $shipyard['certificate'] }}</textarea>
              </div>
...
@section('btmSlot')
  <script>
    let yardArr = {!! !empty($shipyard['yard_location']) ? $shipyard['yard_location'] : '[]' !!};
    let contactArr = {!! !empty($shipyard['contact']) ? $shipyard['contact'] : '[]' !!};
    let gravingArr = {!! !empty($shipyard['graving_dock']) ? $shipyard['graving_dock'] : '[]' !!};
    let floatingArr = {!! !empty($shipyard['floating_dock']) ? $shipyard['floating_dock'] : '[]' !!};
    let shipRepairArr = {!! !empty($shipyard['ship_repair']) ? $shipyard['ship_repair'] : '[]' !!};
    let newBuildingArr = {!! !empty($shipyard['new_building']) ? $shipyard['new_building'] : '[]' !!};
    let imageArr = {!! !empty($shipyard['image']) ? $shipyard['image'] : '[]' !!};
    let videoArr = {!! !empty($shipyard['video']) ? $shipyard['video'] : '[]' !!};
    ...
    function generateYardHtml() {
      ...
      for (let key in yardArr) {
        let yardIndex = parseInt(key) + 1;

        html += `
          <div class="yard__new">
            <div class="pb-3"></div>
            <div class="mb-3 d-flex justify-content-between">
              <div><b>YARD ${yardIndex > 1 ? '('+yardIndex+')' : ''}</b></div>
              <div>
                ${ key == 0 ? '<button type="button" class="btn btn-sm btn-info" onclick="addYard();"><i class="fas fa-plus"></i>Add Yard</button>' : '<button type="button" class="btn btn-sm btn-danger" onclick="removeYard('+key+');"><i class="fas fa-minus"></i> Remove Yard</button>' }
              </div>
            </div>
